...
//        env.getCheckpointConfig().setCheckpointingMode(CheckpointingMode.EXACTLY_ONCE);
        ...
        String querySql = "select substring(stropDate,0,17) as actionDT,substring(stropDate,12,5) as actionMinu," +
                          " HOP_START(rowtime, INTERVAL '3' SECOND, INTERVAL '70' SECOND) as start_time, " +
                          " HOP_END(rowtime, INTERVAL '3' SECOND, INTERVAL '70' SECOND) as end_time," +
                          " appId,funcId,funcName,orgCode,orgName,count(1) as logPV, count(distinct userId) as logUV" +
                            ...
                            " appId,funcId,funcName,orgCode,orgName,substring(stropDate,0,17),substring(stropDate,12,5)"
                            ;
//
